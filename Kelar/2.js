...
var name = 'Budi'; // silakan berikan nilai string bebas untuk nama muridnya
var subject = 'PKN'; //silahkan berikan nilai String bebas untuk nama pelajarannya
var total_classes = 100 //Jumlah kelas yang ada pada pelajaran tersebut (pada satu semester) berisi minimal angka 1, tidak boleh 0.
var participated_classes = 75  //silahkan beri nilai angka bebas, tetapi pastikan angka ini tidak melebihi angka pada 'total_classes'
var doctor =  false//silahkan beri nilai boolean bebas


//Tulis code disini
if (participated_classes >= (total_classes - (total_classes / 4) || doctor === true)) {
    console.log (name + ' boleh mengikuti ujian ulang pelajaran ' + subject)
} else {
    console.log(name + ' tidak boleh mengikuti ujian ulang pelajaran ' + subject +', karena absensinya '+ (100 / (total_classes / participated_classes)) +' persen.')
}